...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    private static VrSettingsSnapshot BuildVrSettingsSnapshot(UserSettings settings) =>
        new(
            ...
            settings.ChatGazeFadeEnabled,
            settings.ChatAutoHideEnabled,
    ...
    internal static UserSettings MergeVrSettingsSnapshot(UserSettings previous, VrSettingsSnapshot snapshot) =>
        previous with
        {
            ...
            ChatGazeFadeEnabled = snapshot.ChatGazeFadeEnabled,
            ChatAutoHideEnabled = snapshot.ChatAutoHideEnabled,
            ChatGazeReference = snapshot.ChatGazeReference,
            ChatBackgroundColour = snapshot.ChatAppearance.SafeBackgroundHex,
            ChatTextColour = snapshot.ChatAppearance.SafeTextHex,
            ChatAccentColour = snapshot.ChatAppearance.SafeAccentHex,
            ChatGlowColour = snapshot.ChatAppearance.SafeGlowHex,
            ChatGlowOpacity = snapshot.ChatAppearance.SafeGlowOpacity,
            ChatGlowSizePixels = snapshot.ChatAppearance.SafeGlowSizePixels,
            ChatBackgroundImagePath = snapshot.ChatAppearance.SafeBackgroundImagePath,
            ChatBackgroundImageOpacity = snapshot.ChatAppearance.SafeBackgroundImageOpacity,
